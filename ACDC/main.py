...
#
# 检查点和目录设置
parser.add_argument("--logdir", type=str, default="logname_acdc")
parser.add_argument("--data_dir", type=str, default="/hy-tmp/ACDC/acdc_split_70_10_20/")  # 必须以分隔符"/"来结尾
parser.add_argument("--json_list", type=str, default="acdc_70_10_20.json")
parser.add_argument("--resume_ckpt", action="store_true")
parser.add_argument("--pretrained_dir", type=str, default="./runs/logname_acdc/")
...
parser.add_argument("--batch_size", type=int, default=1)  # in 3090-24G GPU it's 1
...
parser.add_argument("--base_lr", type=int, default=1e-4)  # 根据batchsize调整 1->1e-4
...
parser.add_argument("--a_max", type=float, default=255.0)
...
parser.add_argument("--roi_z", type=int, default=40)
